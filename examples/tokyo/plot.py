...
def plot_anim(
    ...
    ani = anim.FuncAnimation(
        ...
        frames=1300 * interpolation_frames + 1,
...
if __name__ == "__main__":
    main(
        "a=0.0,p_infection=0.01,lockdown_regulation=0.01",
        "a=0.0,p_infection=0.01,lockdown_regulation=0.1",
        "a=0.0,p_infection=0.01,lockdown_regulation=1.0",
        "a=0.5,p_infection=0.01,lockdown_regulation=0.01",
        "a=0.5,p_infection=0.01,lockdown_regulation=0.1",
        "a=0.5,p_infection=0.01,lockdown_regulation=1.0",
        "a=1.0,p_infection=0.01,lockdown_regulation=0.01",
        "a=1.0,p_infection=0.01,lockdown_regulation=0.1",
        "a=1.0,p_infection=0.01,lockdown_regulation=1.0",
    )
